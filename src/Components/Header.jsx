...
const Header = () => {
  ...
  return (
    <header className="w-full b shadow-sm border-b border-gray-100">
  ...
  <img
    src={logo}
    alt="logo"
    className="w-36 object-contain md:w-40 h-auto max-h-[60px] md:max-h-none"
  />
</div>
...
const Card = ({ icon, title, text, bg }) => {
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-sm ${bg} min-w-[220px]`}
    >
